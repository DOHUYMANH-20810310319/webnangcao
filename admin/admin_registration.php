                ...
                <div class="col-lg-6 col-xl-5 mt-5">
                    <form action="" method="post">
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" class="form-control" id="username" name="admin_name" placeholder="Tên đăng nhập" required="required">
                        </div>
                        <div class="form-outline mb-4">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" name="admin_email" placeholder="Email" required="required">
                        </div>
                        <div class="form-outline mb-4">
                            <label for="password" class="form-label">Mật khẩu</label>
                            <input type="password" class="form-control" id="password" name="admin_password" placeholder="Mật khẩu" required="required">
                        </div>
                        <div class="form-outline mb-4">
                            <label for="confirm_password" class="form-label">Xác nhận mật khẩu</label>
                            <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Xác nhận mật khẩu" required="required">
                        </div>
                        <div>
                            <input type="submit" class="bg-success py-2 px-3 border-0 rounded text-light" name="admin_registration" value="Đăng ký">
                            <p class="small fw-bold mt-2 pt-1">Đã có tài khoản <a href="admin_login.php" class="link-danger"> đăng nhập ngay</a></p>
                        </div>
                    </form>
                </div>
            </div>
