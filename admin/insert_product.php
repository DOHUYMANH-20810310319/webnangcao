...
<body class="bg-light">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" name="product_title" id="product-title" class="form-control" autocomplete="off" required="required">
        </div>
        <!-- mô tả -->
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="description" class="form-label">Mô tả</label>
            <input type="text" name="description" id="description" class="form-control" autocomplete="off" required="required">
        </div>
        <!-- từ khóa -->
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="product_keywords" class="form-label">Từ khóa tìm kiếm</label>
            <input type="text" name="product_keywords" id="product_keywords" class="form-control" autocomplete="off" required="required">
        </div>
        <!--danh mục -->
        <div class="form-outline mb-4 w-50 m-auto">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" name="product_price" id="product_price" class="form-control" autocomplete="off" required="required">
        </div>
        <!--Thêm sản phẩm-->
        <div class="form-outline mb-4 w-50 m-auto">
            <input type="submit" name="insert_product" id="product_price" class="btn btn-success mb-5 px-5" required="required" value="Thêm sản phẩm">
        </div>
