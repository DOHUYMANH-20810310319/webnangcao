    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto" style="flex-basis: 70%">
        ...
        <li class="nav-item" style="font-family:monospace;">
          <a class="nav-link" href="#" style="color:bisque"><img src="./Assets/bag.png"><sup><?php cart_item();?></sup></a>
        </li>
      </ul>
    </div>
  </nav>
    ...
    <form action="" method="post">
        <table class="table table-bordered text-center shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="./admin//product_images/<?php echo$product_image1?>" class="cart_img" alt=""></td>
                    ...
                    <td>
                        <input class="bg-success px-3 text-light border-0 py-2 mx-3 rounded" type="submit" value="Cập nhật" name="update_cart">
                        <!-- <button class="bg-success px-3 text-light border-0 py-2 mx-3 "value="Xoá">Xoá</button> -->
                        <input class="bg-success px-3 text-light border-0 py-2 mx-3 rounded" type="submit" value="Xoá" name="remove_cart">
                    </td>
                </tr>
                <?php }}}
        ...
        <?php 
                ...
                { 
                  ...
                  <a name='continue_shopping' href='./index.php'><button class='bg-success p-3 text-light border-0 py-2 mx-3 rounded'>Tiếp tục mua sắm</button></a>
