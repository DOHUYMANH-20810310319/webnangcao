  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color:  rgb(34, 24, 24); font-family:monospace, Helvetica, sans-serif;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="search_product.php" method="get" class="form-inline my-1 my-lg-0 d-flex" style="margin-right: 45px;flex-basis: 30%">
        <input type="search" name="search_data" style="margin-right: 15px" class="form-control me-2" placeholder="Tìm kiếm sản phẩm" aria-label="Search">
        <input name="search_data_product" class="btn btn-outline-success my-2 my-sm-0" type="submit" value="Tìm"><?php search_product(); ?>
      </form>
    </div>
  </nav>
  <!--gọi hàm cart-->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <ul class="navbar-nav me-auto">
      ...
      if (!isset($_SESSION['username'])) {
        ...
        echo "
        <li class='nav-item'>
        <a class='nav-link' href='./user_area/profile.php'>Chào mừng " . $_SESSION['username'] . "</a>
        </li>
        <li class='nav-item'>
