            ...
            <h2 class="text-center">Đăng ký tài khoản mới</h2>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="password" id="user_password" class="form-control"  placeholder="Nhập mật khẩu" required="required" name="user_password"/>
                    </div>
                    <!--password-->
                    <div class="form-outline mb-4">
                        <label for="conf_user-password" class="form-label">Xác nhận mật khẩu</label>
                        <input type="password" id="conf_user_password" class="form-control" placeholder="Nhập lại mật khẩu" required="required" name="conf_user_password"/>
                    </div>
                    <!--address-->
                    <div class="form-outline mb-4">
                        <label for="user-address" class="form-label">Địa chỉ</label>
                        <input type="search" id="user_address" class="form-control" placeholder="Nhập địa chỉ" required="required" name="user_address"/>
                    </div>
                     <!--phone-->
                     <div class="form-outline mb-4">
                        <label for="user-contact" class="form-label">Số điện thoại</label>
                        <input type="search" id="user_contact" class="form-control" placeholder="Nhập địa chỉ" required="required" name="user_contact"/>
                    </div>
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Đăng ký" class="bg-success py-2 px-2 border-0 rounded text-light" name="user_register"/>
                        <p class="medium fw-bold mt-2 pt-1 mb-0">Đã có tài khoản, <a href="./user_login.php">đăng nhập ngay</a></p>
                    </div>
                </form>
            </div>
        </div>
