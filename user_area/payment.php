...
?>
  ...
  <div class="container">
      ...
      <div class="row d-flex justify-content-center algin-items-center">
        <div class="col-md-6">
        <a href="https://www.paypal.com/vn/home?locale.x=vi_VN" target="_blank"><img src="../Assets/payment.jpg" style="width:500px;display:block" alt=""><h2 class="text-center">Thanh toán online</h2> </a>  
        </div>
        <div class="col-md-6">
        <a href="order.php?user_id=<?php echo $user_id ?>"><img src="../Assets/Lai-Suat-Ngan-Hang-C-01.jpg" style="width:500px; height:377px;" alt=""><h2 class="text-center">Thanh toán trực tiếp</h2></a>  
        </div>       
      </div>
    </div>
</body>
