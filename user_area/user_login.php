...
<body>
    <div class="container-fluid mt-2 mb-2 ">
        ...
        <div class="row mt-5 algin-items-center justify-content-center ">
            ...
            <div><h2 class="text-center text-dark">Đăng nhập</h2></div>
                <form action="" method="post">
                    ...
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Đăng nhập" class="bg-success py-2 px-2 border-0 rounded text-light" name="user_login"/>
                        <p class="medium fw-bold mt-2 pt-1 mb-0">Chưa có tài khoản, <a href="./user_registration.php">đăng ký ngay</a></p>
                    </div>
                </form>
            </div>
        </div>
